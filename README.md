...
| [docs/DELIVERY-SHAPES.md](docs/DELIVERY-SHAPES.md) | conventions, the `landing/`+`ready/` split, the archive normalizer and the control-file gate are built; the onboarding sniffer's backend is built, its console wiring is not |
