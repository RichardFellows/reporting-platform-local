...
| [docs/DELIVERY-SHAPES.md](docs/DELIVERY-SHAPES.md) | all five steps built, live-verified; the console still cannot CREATE an archive/control-gated feed through its form |
